...
namespace MyWeather.Services
{
    ...
    {
        const string WeatherCoordinatesUri = "http://api.openweathermap.org/data/2.5/weather?lat={0}&lon={1}&units={2}&appid=6861b5f152084f4824be91d7b3dbce22";
        const string WeatherCityUri = "http://api.openweathermap.org/data/2.5/weather?q={0}&units={1}&appid=6861b5f152084f4824be91d7b3dbce22";
        const string ForecaseUri = "http://api.openweathermap.org/data/2.5/forecast?id={0}&units={1}&appid=6861b5f152084f4824be91d7b3dbce22";
